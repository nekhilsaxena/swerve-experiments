...
public:
    ...
    // robotVelocity: Velocity of the FRAME where the module is mounted (meters/sec)
    // Returns: The force vector applied TO THE ROBOT CHASSIS at this module location
